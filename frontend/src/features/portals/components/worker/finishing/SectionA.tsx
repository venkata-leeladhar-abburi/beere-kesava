  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      <div className="flex flex-col gap-4 w-full mb-2">
        <ScanBar value={scanValue} onChange={setScanValue} onSubmit={submitScan} onDetected={submitDetected} inputRef={scanRef} />
        ...
        <SearchInput
          ...
          onSearch={setSearch}
          placeholder="Search by saree ID, weaver, loom, batch, design, bulk order…"
          className="w-full"
        />

        <div className="flex flex-wrap items-center gap-2 w-full">
          <Select value={filterWeaver} onValueChange={setFilterWeaver} className="w-[200px] max-w-full">
