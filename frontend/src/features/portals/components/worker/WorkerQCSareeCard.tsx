      ...
      <div className="rounded-2xl border border-[#F0E5D8] bg-[#FAF8F5] p-3.5 sm:p-4 space-y-2">
        ...
        <div className="flex items-baseline justify-between pt-1">
          <div className="flex items-baseline gap-1.5">
            <span style={{ fontFamily: F.m }} className="text-[21px] font-bold text-[#1D1814] leading-none">
              {s.weight > 0 ? `${s.weight}g` : "0g"}
            </span>
            <span style={{ fontFamily: F.u }} className="text-[13px] font-normal text-[#69635E]">
              / {s.std}g std
            </span>
          </div>

          <div style={{ fontFamily: F.u }} className="text-[11.5px] text-[#69635E]">
            {s.weight > 0 ? `${v.d > 0 ? "+" : ""}${v.d}g from std` : s.submitted}
          </div>
        </div>
      </div>
