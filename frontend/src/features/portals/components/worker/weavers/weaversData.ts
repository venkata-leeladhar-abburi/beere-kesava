...
export interface BatchSaree { no: number; sareeId: string; serial: number; status: SareeStatus; isRework?: boolean; color?: string; weight?: string; warp?: string; resham?: string; jari?: string; weaverLoom?: number; }
