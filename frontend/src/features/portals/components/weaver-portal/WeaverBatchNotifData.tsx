...
export const WN_DATA: WeaverNotif[] = [
  ...
  { id: 3, priority: "critical", category: "batch",   title: "Defect found — Saree PADMA-L1-004",      body: "Saree PADMA-L1-004 from BATCH-086 has failed quality check inspection. Defect type: Thread break on the border section. A ₹450 deduction will be applied this month.",                                            time: "11:30 AM", date: "10 Jun",    read: false, action: "View Defect" },
  ...
  { id: 5, priority: "success",  category: "payment", title: "Payment credited — ₹6,300",               body: "April 2026 making charges of ₹6,300 have been successfully credited to your bank account. UTR Reference: UTR202604301122.",                                                                                           time: "9:02 AM",  date: "01 May",    read: true  },
  ...
  { id: 7, priority: "success",  category: "warp",    title: "Warp request approved — BATCH-089",      body: "Your warp request for 3 kg Warp for BATCH-089 has been reviewed and approved by the supervisor. The material will be issued within the next 1–2 working days.",                                                        time: "12:00 PM", date: "10 Jun",    read: true  },
  { id: 8, priority: "warning",  category: "warp",    title: "Warp request rejected — BATCH-086",      body: "Your request for Resham Red 500g for BATCH-086 has been rejected. Reason: Sufficient stock is available from your original issue.",                                                                                   time: "3:30 PM",  date: "05 Jun",    read: true  },
];
