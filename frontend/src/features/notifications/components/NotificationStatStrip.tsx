        ...
        {[
          ...
          >
            <div style={{ flex: 1, minWidth: 0 }}>
              ...
              <div style={{ fontFamily: F.ui, fontWeight: 600, fontSize: 30, letterSpacing: "-0.02em", color: m.hi ? T.goldLight : (m.col || "#FFFDF9"), lineHeight: 1.1, marginBottom: 8, fontVariantNumeric: "tabular-nums" as const }}>
                {m.val}
              </div>
            </div>
