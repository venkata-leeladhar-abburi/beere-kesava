  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", flexDirection: "column", flex: 1 }}>
        {/* Header */}
        <div style={{ padding: "0 20px 14px", display: "flex", flexWrap: "wrap", alignItems: "center", gap: 12, flexShrink: 0 }}>
        ...
        {/* Body / Amount */}
        <div style={{ padding: "16px 20px", borderTop: `1px solid rgba(110,15,45,0.06)`, borderBottom: `1px solid rgba(110,15,45,0.06)`, flexShrink: 0, display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          <div>
      ...
      {/* Actions */}
      <div style={{ padding: "14px 20px 20px", display: "flex", flexWrap: "wrap", gap: 8, flexShrink: 0 }}>
        <Button variant="secondary" size="sm" iconLeft={Eye} onClick={onView}
          className="flex-1 min-w-[120px] rounded-[10px] border-[1.5px] border-[rgba(110,15,45,0.12)] text-[#6E0F2D]">
          View Details
        </Button>
        {isPaid ? (
          <Button variant="secondary" size="sm" iconLeft={BadgeCheck} disabled
            className="flex-1 min-w-[120px] rounded-[10px] border-[1.5px] border-[rgba(30,102,64,0.18)] bg-[rgba(30,102,64,0.07)] text-[#1E6640] disabled:bg-[rgba(30,102,64,0.07)] disabled:text-[#1E6640] disabled:opacity-100">
            Completed
          </Button>
        ) : (
          <Button variant="primary" size="sm" iconLeft={UploadCloud}
            className="flex-1 min-w-[120px] rounded-[10px] bg-[#6E0F2D] hover:bg-[#4A0A1D]">
            Update Status
          </Button>
        )}
      </div>
