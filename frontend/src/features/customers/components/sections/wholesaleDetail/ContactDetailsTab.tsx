        ...
        <div style={{ background: "#fff", borderRadius: 16, border: `1px solid ${T.borderDef}`, padding: 24, boxShadow: "0 2px 8px rgba(0,0,0,0.02)" }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2" style={{ gap: 20 }}>
            <div>
              ...
              <div style={{ fontFamily: F.ui, fontSize: 15, fontWeight: 600, color: T.luxuryBrown, marginTop: 4 }}>{customer.contactName || "—"}</div>
            </div>
            <div>
              <div style={{ fontFamily: F.ui, fontSize: 13, color: T.taupe, display: "flex", alignItems: "center", gap: 6 }}><FileText size={14} /> GSTIN</div>
              <div style={{ fontFamily: "var(--font-mono)", fontSize: 14, fontWeight: 600, color: T.royalBurgundy, marginTop: 4 }}>{customer.gstNumber || "Unregistered"}</div>
            </div>
            <div>
              <div style={{ fontFamily: F.ui, fontSize: 13, color: T.taupe, display: "flex", alignItems: "center", gap: 6 }}><Phone size={14} /> Phone Number</div>
              <div style={{ fontFamily: "var(--font-mono)", fontSize: 15, color: T.luxuryBrown, marginTop: 4 }}>{customer.phone || "—"}</div>
            </div>
            <div>
              ...
              <div style={{ fontFamily: "var(--font-mono)", fontSize: 15, color: T.luxuryBrown, marginTop: 4 }}>{customer.whatsapp || "—"}</div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2" style={{ gap: 24 }}>
            ...
            {hasBankDetails ? (
              <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                <div>
                  ...
                  <div style={{ fontFamily: F.ui, fontSize: 14, color: T.luxuryBrown, fontWeight: 500 }}>{customer.bankName || "—"}</div>
                </div>
                <div>
                  <span style={{ fontFamily: F.ui, fontSize: 12, color: T.taupe }}>Account:</span>
                  <div style={{ fontFamily: "var(--font-mono)", fontSize: 14, color: T.luxuryBrown }}>{customer.accountNumber || "—"}</div>
                </div>
                <div>
                  <span style={{ fontFamily: F.ui, fontSize: 12, color: T.taupe }}>IFSC:</span>
                  <div style={{ fontFamily: "var(--font-mono)", fontSize: 14, color: T.luxuryBrown }}>{customer.ifscCode || "—"}</div>
                </div>
              </div>
            ) : (
          ...
          <div style={{ background: "#fff", borderRadius: 16, border: `1px solid ${T.borderDef}`, padding: 24, boxShadow: "0 2px 8px rgba(0,0,0,0.02)" }}>
            ...
            <div style={{ fontFamily: F.ui, fontSize: 14, color: T.luxuryBrown, lineHeight: 1.6 }}>
              {customer.notes || "No special notes or instructions for this customer."}
            </div>
          </div>
        </div>
