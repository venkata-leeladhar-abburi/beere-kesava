              ...
              {rows.map(o => {
                ...
                return (
                  <tr key={o.ref} style={{ borderBottom: `1px solid ${T.borderDef}` }}>
                    ...
                    <td style={{ padding: "14px 16px", fontFamily: F.ui, fontSize: 13, color: T.taupe }}>{o.due}</td>
                    <td style={{ padding: "14px 16px", fontFamily: F.ui, fontSize: 13, color: T.luxuryBrown }}>
                      {o.sareeType}
                    ...
                    <td style={{ padding: "14px 16px" }}>
                      <span style={{ background: meta.bg, color: meta.color, padding: "3px 9px", borderRadius: 6, fontSize: 12, fontWeight: 700, whiteSpace: "nowrap" as const }}>{meta.label}</span>
                    </td>
                    <td style={{ padding: "14px 16px" }}>
                      <span style={{ background: pay.bg, color: pay.color, padding: "3px 9px", borderRadius: 6, fontSize: 12, fontWeight: 700 }}>{pay.label}</span>
                    </td>
                    <td style={{ padding: "14px 16px" }}>
