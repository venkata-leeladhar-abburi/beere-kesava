    ...
    <AnimatePresence>
      {open && (
        <motion.div
          ...
          onClick={onClose}
          style={{ position: "fixed", inset: 0, background: "rgba(61,14,26,0.60)", backdropFilter: "blur(4px)", zIndex: "var(--z-modal)", display: "flex", alignItems: "center", justifyContent: "center", padding: 16 }}
        >
          <motion.div
