      ...
      {filteredQuotations.length === 0 ? (
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
          {filteredQuotations.map(qt => {
            ...
            return (
              <div key={qt.id} style={{ border: `1px solid rgba(110,15,45,0.18)`, borderRadius: 14, overflow: "hidden", boxShadow: "0 1px 2px rgba(74,6,27,0.03), 0 6px 18px rgba(74,6,27,0.05)" }}>
