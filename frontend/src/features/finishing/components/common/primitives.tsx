...
// This feature has no shared theme file (each section defines its own local
// T/F consts) — kept self-contained here rather than picking one file's copy
...
// Users, Inventory, Pricing, Notifications, Batches, and Designs pages.
